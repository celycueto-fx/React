...
export default function Character() {
  ...
  const floorNormal = useMemo(() => new THREE.Vector3(0, 4, 0));
  ...
  useFrame((state, delta) => {
    ...
    /**
     * Apply character position to directional light position={[10,0,5]}
     */
    if (dirLight) {
      dirLight.position.x = currentPos.x +10;
      dirLight.position.y = currentPos.y + 5;
      dirLight.position.z = currentPos.z + 20;
  ...
  return (
    <RigidBody
      ...
      position={[18,1.2,-8]} rotation={[0,180,0]}
      friction={-0.5}
      ref={characterRef}
    >
